...
class flipkard:
    ...
    def get_SingleOrderAddressInfo(self,orderId):
        ...
        #关闭选项卡
        # self.brower.execute_script('window.close()')
    ...
    def run(self):
        ...
        return accountname,paymentsinfo,myordersinfo,accountinfo,mystuffinfo


    def SaveDB(self, table,accountname,paymentsinfo,myordersinfo,accountinfo,mystuffinfo):
            ...
            print('************************************************************************')
            print("******信息爬取完成，并且数据保存到Flipkar_DB中，需要数据可以在Flipkar_DB中查找******")
...
if __name__ == "__main__":
    ...
    accountname, paymentsinfo, myordersinfo, accountinfo, mystuffinfo = flipkard.run()
    print(accountname, paymentsinfo, myordersinfo, accountinfo, mystuffinfo)
    flipkard.SaveDB(table,accountname,paymentsinfo,myordersinfo,accountinfo,mystuffinfo)
    #
